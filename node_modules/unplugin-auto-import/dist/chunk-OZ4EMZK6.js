...
var _chunkYTHWPDQDjs = require('./chunk-YTHWPDQD.js');
...
function resolveOptions(options = {}, root = process.cwd()) {
  ...
  const resolved = _chunkYTHWPDQDjs.__spreadProps.call(void 0, _chunkYTHWPDQDjs.__spreadValues.call(void 0, {
    sourceMap: false,
    resolvedImports: {},
...
function flattenImportsMap(map, overriding = false) {
  ...
  _utils.toArray.call(void 0, map).forEach((definition) => {
    if (typeof definition === "string") {
      if (!_chunkYTHWPDQDjs.presets[definition])
        throw new Error(`[auto-import] preset ${definition} not found`);
      const preset = _chunkYTHWPDQDjs.presets[definition];
