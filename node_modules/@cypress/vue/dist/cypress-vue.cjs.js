...
Cypress.on('run:start', function () {
    ...
    Cypress.on('test:before:run', function () {
        ...
        if (!el) {
            throw Error("no element found at query #" + mountUtils.ROOT_ID + ". Please use the mount utils to mount it properly");
        }
        el.innerHTML = '';
...
function mount(componentOptions, options) {
    ...
    return cy.then(function () {
        ...
        mountUtils.injectStylesBeforeElement(options, document, el);
        ...
        var wrapper = testUtils.mount(componentOptions, __assign({ attachTo: componentNode }, options));
