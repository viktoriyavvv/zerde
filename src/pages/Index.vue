<template>
  ...
  <div class="relative flex w-full h-[900px]">
    ...
    <div class="lg:container mx-auto mt-40 relative text-white sm:static z-20">
      <h1 class="text-[56px] sm:pt-[120px] pt-[340px] mb-5">ШКОЛА ZERDE</h1>

      <p class="text-2xl mb-[35px] w-[540px]">
  ...
  <div class="max-w-[1180px] mx-auto">
    <div class="sm:pt-[80px] sm:pb-[80px] pt-20 pb-20">
      <div class="lg:container mx-auto p-2.5 xl:p-0">
        <div class="mx-auto flex justify-between font-medium">
          ...
          <button class="mt-2 flex text-base whitespace-nowrap">
            Перейти к новостям
            <ArrowIcon class="ml-5 mt-1" />
          </button>
        </div>
        <div
          class="flex justify-center flex-wrap mt-[40px] space-x-0 sm:md:lg:xl:space-x-5"
        >
          <div
            class="sm:md:lg:w-[580px] h-[500px] bg-cover bg-no-repeat bg-center rounded-[30px] px-[30px] py-[30px]"
            style="background-image: url('/src/assets/images/Picture2.jpg')"
          >
            <div
              class="flex flex-col justify-end h-[100%] text-base text-[#FFFFFF]"
            >
              <p class="text-[32px] mb-[15px]">Zerde SHON жобасына ұласты</p>
              <p>
                2007 жылы Нуровтар әулеті дағдарыс салдарынан жабылып қалған
                мектептің мықты...
              </p>
              <div class="flex justify-between mt-[25px]">
                <button class="flex text-base whitespace-nowrap font-semibold">
                  Читать далее
                  <ArrowWhite class="w-[10px] h-[17px] ml-5 mt-1" />
                </button>
                <p>25/02/2021</p>
              </div>
            </div>
          ...
          <div class="space-y-5 mt-5 sm:md:lg:xl:mt-0">
            <div
              class="sm:md:lg:w-[580px] h-[240px] bg-cover bg-no-repeat bg-center rounded-[30px] px-[30px] py-[30px]"
              style="background-image: url('/src/assets/images/Picture3.jpg')"
            >
              <div
                class="flex flex-col justify-between h-[100%] text-base text-[#FFFFFF]"
              >
                <p class="text-[32px]">Последний звонок для 1, 9, 11 классов</p>
                <div class="flex justify-between">
                  <button
                    class="flex text-base whitespace-nowrap font-semibold"
                  >
                    Читать далее
                    <ArrowWhite class="w-[10px] h-[17px] ml-5 mt-1" />
                  </button>
            ...
            <div
              class="sm:md:lg:w-[580px] h-[240px] bg-cover bg-no-repeat bg-center rounded-[30px] px-[30px] py-[30px]"
              style="background-image: url('/src/assets/images/Picture4.jpg')"
            >
              <div
                class="flex flex-col justify-between h-[100%] text-base text-[#FFFFFF]"
              >
                <div>
                  <p class="text-[32px] mb-[15px]">IVY LEAGUE</p>
                  <p>
                    2007 жылы Нуровтар әулеті дағдарыс салдарынан жабылып қалған
                    мектептің мықты...
                  </p>
      ...
      <div class="lg:container mx-auto p-2.5 xl:p-0">
        ...
        <div class="flex justify-center">
          <div class="sm:w-[640px] w-full">
            <div class="mt-[30px] rounded-lg bg-[#F1F1F1] py-5 px-5 shadow-sm">
              <div class="flex">
            ...
            <div class="mt-5 rounded-lg bg-[#F1F1F1] py-5 px-5 shadow-sm">
              <div class="flex">
                ...
                <div>
                  ...
                  <p class="text-sm text-[#313131]">
                    Для нас важно развивать личную и коллективную
                    ответственность. Конкурентоспособность человека определяет
                    способность принимать ответственные решения, продуктивно и
              ...
              <div class="flex">
                ...
                <div>
                  ...
                  <p class="text-sm text-[#313131]">
                    ...
                    неразрывно связаны между собой. Честность определяет
                    взаимное доверие учащихся, учителей и родителей.
                  </p>
                </div>
              </div>
            </div>
            <div class="mt-5 rounded-lg bg-[#F1F1F1] py-5 px-5 shadow-sm">
              <div class="flex">
                ...
                <div>
                  ...
                  <p class="text-sm text-[#313131]">
                    Уровень мастерства наших педагогов обеспечивает развитие
                    ребенка от детского сада до определения профессиональной
                    ориентации выпускника школы. В результате тщательного выбора
                    методов для каждого ребенка формируются молодые граждане с
                    развитой социальной мобильностью.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="ml-5 mt-6 space-y-7">
            ...
            <img
              src="/src/assets/images/Picture6.jpg"
              class="shadow-2xl w-[520px]"
              alt="..."
            />

            <img
              src="/src/assets/images/Picture7.jpg"
              class="shadow-2xl w-[520px]"
              alt="..."
            />

            <img
              src="/src/assets/images/Picture8.jpg"
              class="shadow-2xl w-[520px]"
              alt="..."
            />
          </div>
    ...
    <div class="sm:pt-[80px] sm:pb-[80px] pt-20 pb-20">
      <div class="lg:container mx-auto p-2.5 xl:p-0">
        ...
        >
          ...
          >
            <img
              src="/src/components/icons/Certificate.svg"
              alt="certificate"
            />
    ...
    <div class="bg-[#ffffff] sm:pt-[80px] sm:pb-[80px] pt-20 pb-20">
      <div class="lg:container mx-auto p-2.5 xl:p-0">
        ...
        <div class="mt-10">
          <div class="flex justify-center space-x-10 items-center flex-wrap">
...
.link_button:hover {
  background: #ffffff;
  box-shadow: 0px 0px 1px rgba(12, 26, 75, 0.25),
    0px 1px 2px rgba(50, 50, 71, 0.15);
